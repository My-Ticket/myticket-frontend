...
const historial = [
      {pelicula: "Rapidos y furiosos X", fecha: "10/06/2023", boletos: "2", sala: "2"},
      {pelicula: "Transformers", fecha: "12/06/2023", boletos: "3", sala: "1"},
      {pelicula: "El señor de los anillos", fecha: "13/06/2023", boletos: "1", sala: "3"},
      ...
      {pelicula: "Guardianes de la galaxia vol.3", fecha: "20/06/2023", boletos: "10", sala: "2"},
      {pelicula: "Titanic", fecha: "21/06/2023", boletos: "11", sala: "1"},
      {pelicula: "Super Mario Bros", fecha: "22/06/2023", boletos: "12", sala: "4"},
